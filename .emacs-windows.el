...
(custom-set-variables
 ...
 '(package-selected-packages
   '(yaml-mode org-recent-headings evil academic-phrases helm-org magit json-mode orgalist org-cliplink x-path-walker exato ahk-mode pdf-tools tablist magit-svn orgnav sparql-mode xquery-mode hyperbole pandoc org2blog pandoc-mode mediawiki bookmark+ htmlize winum general-close dash-functional cygwin-mount image+ peep-dired use-package ebib google-this helm-bibtex company-auctex company-math company-ngram company-statistics company-web org-clock-convenience evil-quickscope which-key helm-org-rifle operate-on-number 2048-game ag avy emmet-mode evil-exchange evil-surround helm-ag hydra n3-mode powershell psvn helm-projectile yasnippet auctex markdown-mode csv-mode charmap writegood-mode rdf-prefix omn-mode langtool inflections helm git-timemachine evil-org evil-numbers evil-matchit evil-leader discover diminish))
